...
function BookVisitForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit form
      const result = await submitForm(formData, 'book-visit');
  ...
  return (
    <div className="book-visit-form-desktop d-none d-lg-block">
      <div className="glass-card">
        <h3 className="form-title">Book A Site Visit</h3>
        <form method="POST" onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <PhoneInputWithCountry
              ...
              inputClass="form-control glass-input"
              placeholder="Mobile"
            />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <div className="form-check">
              <input
                ...
                required
              />
              <label htmlFor="consent" className="form-check-label consent-text">
